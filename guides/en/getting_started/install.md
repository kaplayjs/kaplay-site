...
<script type="module">
    // import kaplay
    import kaplay from "https://unpkg.com/kaplay@3001.0.0-alpha.18.2/dist/kaplay.mjs";
    // start kaplay
    kaplay();
</script>
```
...
```html
<script src="https://unpkg.com/kaplay@3001.0.0-alpha.18.2/dist/kaplay.js"></script>
