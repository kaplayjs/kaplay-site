...
If you're new in the **JavaScript World** and you don't know what a Node is,
what a Bundler is or what to do with your life in general,
check our [Basic Knowledge](#basic-knowledge) section.
</Info>

## Recommended Installation

Once you have [Node](https://nodejs.org/en/download) Installed, the most easy way to get started with **KAPLAY** is to use
...
That's! You're ready to **start making games**. If you want to know all the options available
...
For using this method correctly, you can't just open the `index.html`, you need
to serve your files. **After using any of the 2 methods**, run `http-server`:
...
Then, import KAPLAY library inside `index.html`:
...
like `esbuild`, `webpack`, `parcel`, `vite` and etc. This is a short example using [`esbuild`](https://esbuild.github.io/).
