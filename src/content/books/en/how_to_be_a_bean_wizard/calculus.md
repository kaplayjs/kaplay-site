...
We can now say, given an angle, how high the projectile will go, and only shoot when it won't hit the ceiling.
But we can do better than that, since we know that
...
The second derivative of our ballistics function is
...
In case you don't remember how to calculate the derivative of a function, here is a short guide.
For a constant function, the derivative is 0.
