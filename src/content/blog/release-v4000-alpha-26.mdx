...
Hey! lajbel here. We're in the new year! 20**26**, and I'm happy to showcase you the KAPLAY v4000 Alpha **26**.
...
Note that `body()` objects don't need `AreaComp.isSensor`.
