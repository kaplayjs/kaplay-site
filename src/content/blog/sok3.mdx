...
Other things includes bug fixes, collisions adjustments and more. We
...
KAPLAY to many people, gifted stickers and also gave away some pins. From here,
...
- Some cool editor integrations like seeing previews of `loadXXXX` funcs, or load
  assets from a Context Menu instead of writing them manually.

I don't have a date for it at the moment, but probably coming this month. You can also try
