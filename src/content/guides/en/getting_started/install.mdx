...
export const file = version.startsWith("3001") ? "kaplay" : "kaboom";

export const ecmaImport = `<script type="module">
    // import kaplay
    import kaplay from "https://unpkg.com/kaplay@${version}/dist/${file}.mjs";
    // start kaplay
    kaplay();
</script>
`;
export const jsImport = `<script src="https://unpkg.com/kaplay@${version}/dist/${file}.js"></script>
