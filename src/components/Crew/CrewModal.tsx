...
export const CrewModal = ({ setOpenHandler }: CrewModalProps) => {
    ...
    const factDialogRef = useRef<HTMLDialogElement | null>(null);
    ...
    const handleOpenFact = () => {
        factDialogRef?.current?.showModal();
    };

    const handleClose = () => dialogRef?.current?.close();
    const handleCloseFact = () => factDialogRef?.current?.close();
    ...
    return (
        ...
        >
            ...
            <dialog ref={factDialogRef} class="modal p-4 bg-[#0a0c10]/60">
                <div
                    class="modal-box flex p-0 m-0 w-full max-w-[calc(64rem-4rem)] max-h-full focus:outline-none"
                    tabIndex={0}
                >
